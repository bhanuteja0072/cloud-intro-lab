# Big Data and Cloud Computing Lab: Exploring the Cloud Service Stack ☁️
...
* **Platform as a Service (PaaS):** Deployed the static application via Render, leveraging managed runtime environments and deployment tooling while bypassing OS and hardware management.
* **On-Demand Self-Service:** Provisioned the repository and deployment pipeline autonomously.
* **Rapid Elasticity & Broad Network Access:** Deployed to a globally accessible URL capable of scaling resources automatically to handle traffic spikes.
